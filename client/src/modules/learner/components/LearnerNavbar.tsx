  ...
  if (isBlocked) {
    return (
      <nav
        className={`flex items-center justify-between px-6 py-3 bg-white shadow-md ${className}`}
      >
        <div className="w-full text-center py-4 bg-red-100 text-red-800 rounded-lg">
  ...
  if (!isVerified) {
    return (
      <nav
        className={`flex items-center justify-between px-6 py-3 bg-white shadow-md ${className}`}
      >
        <div className="w-full text-center py-4 bg-yellow-100 text-yellow-800 rounded-lg">
          Please verify your email to access full platform features.
        </div>
      </nav>
    );
  }
