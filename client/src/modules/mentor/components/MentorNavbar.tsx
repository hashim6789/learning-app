...
const Navbar: React.FC<MentorNavbarProps> = () => {
  ...
  return (
    <>
      ...
      {/* Matches navbar height (py-4 = 16px * 2 + content) */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-4 bg-white border-b border-purple-100 shadow-sm">
        {/* Logo Section */}
