...
//     const existingLearner = await this.learnerRepository.fetchByField(
//       {email:data.email}
//     );

//     if (existingLearner) {
//       if (!existingLearner.isVerified) {
//         await this.learnerRepository.deleteById(existingLearner.id);
...
//     const createdLearner = await this.learnerRepository.create(learner);
